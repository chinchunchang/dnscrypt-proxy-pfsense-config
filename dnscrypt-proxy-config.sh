fetch -m https://github.com/felixonmars/dnsmasq-china-list/raw/master/accelerated-domains.china.conf
...
cat accelerated-domains.china.conf | grep -v '^#server' | sed -e 's|/| |g' -e 's|^server= ||' | sed 's/114.114.114.114/223.5.5.5,119.29.29.29/g' >>dnscrypt-forwarding-rules.txt

fetch -m https://github.com/felixonmars/dnsmasq-china-list/raw/master/bogus-nxdomain.china.conf
...
fetch -m https://github.com/missdeer/blocklist/raw/master/toblock-without-shorturl-optimized.lst
...
fetch -m https://github.com/googlehosts/hosts/raw/master/hosts-files/dnscrypt-proxy-cloaking.txt
...
fetch -m https://raw.githubusercontent.com/jedisct1/dnscrypt-proxy/master/dnscrypt-proxy/example-dnscrypt-proxy.toml
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-proxy/master/dnscrypt-proxy/example-captive-portals.txt -O dnscrypt-captive-portals.txt
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-resolvers/master/v3/odoh-relays.md
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-resolvers/master/v3/odoh-servers.md
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-resolvers/master/v3/parental-control.md
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-resolvers/master/v3/public-resolvers.md
fetch -m https://raw.githubusercontent.com/DNSCrypt/dnscrypt-resolvers/master/v3/relays.md
fetch -m https://www.quad9.net/quad9-resolvers.md
